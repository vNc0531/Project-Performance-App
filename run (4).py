...
def process():
    ...
    tg_general_df = tg_general_df.rename(columns={
        ...
        "TG1Date": "TG1_Date",
        "TG4EstimatedDate": "TG4_Estimated_Date",
        "TG4ActualDate": "TG4_Actual_Date",
    })

    general_cols = ["ProjectID", "ProjectClass", "TG1_Date", "TG3_Estimated_Date", "TG3_Actual_Date", "TG4_Estimated_Date", "TG4_Actual_Date"]
    tg_general_df = tg_general_df.reindex(columns=general_cols)

    for col in ["TG1_Date", "TG3_Estimated_Date", "TG3_Actual_Date", "TG4_Estimated_Date", "TG4_Actual_Date"]:
        tg_general_df[col] = pd.to_datetime(tg_general_df[col], errors="coerce")
